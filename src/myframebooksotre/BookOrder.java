...
public class BookOrder extends javax.swing.JInternalFrame {
   ...
   String id="";
public void display(){
    co.viewTable("select * from BOOK_ORDER", jTable1);
    ...
    private void initComponents() {
        ...
        jPanel2.add(txt1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 200, -1, -1));

        txt2.setForeground(new java.awt.Color(153, 153, 153));
        txt2.setToolTipText("");
        txt2.setPlaceholder("Enter Order ID");
        jPanel2.add(txt2, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 280, -1, -1));

        txt3.setForeground(new java.awt.Color(153, 153, 153));
        txt3.setToolTipText("");
        txt3.setPlaceholder("Enter Book ID");
        jPanel2.add(txt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 370, -1, -1));
        ...
        jLabel6.setText("Book order ID");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 160, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 80, 550, 690));
        ...
        jPanel1.add(rSLabelTextIcon2, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, -10, 550, 120));
    ...
    private void rSButtonMaterialIconOne3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne3ActionPerformed
        // TODO add your handling code here:
           String sql= "update BOOK_ORDER set ORDERID='"+txt2.getText()+"',BOOKID='"+txt3.getText()+"' where BOOKORDERID='"+txt1.getText()+"'   ";
        co.setSQL(sql);
        display();
        txt1.setText("");
        txt2.setText("");
    ...
    private void rSButtonMaterialIconOne2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne2ActionPerformed
        // TODO add your handling code here:
          String sql= "insert into BOOK_ORDER values('"+txt1.getText()+"','"+txt2.getText()+"','"+txt3.getText()+"')";
        co.setSQL(sql);
        display();
        txt1.setText("");
        txt2.setText("");
    ...
    private void rSButtonMaterialIconOne5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne5ActionPerformed
        // TODO add your handling code here:
           ...
           String sql="select * from BOOK_ORDER where BOOKORDERID='"+txt1.getText()+"' or ORDERID='"+txt2.getText()+"' or BOOKID='"+txt3.getText()+"'";
        co.search(sql);
        try{
            if(co.rs.next()){
    ...
    private void rSButtonMaterialIconOne1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne1ActionPerformed
        // TODO add your handling code here:
         String sql="delete from BOOK_ORDER where BOOKORDERID='"+txt1.getText()+"' ";
          co.setSQL(sql);
        display();
         txt1.setText("");
        txt2.setText("");
